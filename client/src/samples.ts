...
const specFolder = "samples/specs";
...
async function init(): Promise<void> {
    ...
    if (plotParam) {
        ...
        Common.renderSamplesGrid(content, categories);
    }
...
async function renderDetail(content: HTMLDivElement, categories: ISampleCategory[], plotName: string): Promise<void> {
    ...
    const detail = document.getElementById("samplesDetail") as HTMLDivElement;
    const detailTitle = document.getElementById("samplesDetailTitle") as HTMLHeadingElement;
    const detailDescription = document.getElementById("samplesDetailDescription") as HTMLDivElement;
    const detailImage = document.getElementById("samplesDetailImage") as HTMLImageElement;
    const detailNotes = document.getElementById("samplesDetailNotes") as HTMLDivElement;
    const detailTryLink = document.getElementById("samplesDetailTryLink") as HTMLAnchorElement;
    const detailSpec = document.getElementById("samplesDetailSpec") as HTMLElement;
